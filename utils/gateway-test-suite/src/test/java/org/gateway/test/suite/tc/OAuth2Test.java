...
/*import org.gateway.test.suite.tc.config.CucumberStepsDefinition;*/
...
public class OAuth2Test {
	...
	/**
	 *    The oauth2 token https://somehost.com/auth/oauth/v2/token and the json:
	 * 
	 * @param name
	...
	/**
	 * When I access the https://somehost.com/dev/ldapsearch/api/persons url with queryParam ntid=somnath.upadhyay
	 * @param ntid
	 */
