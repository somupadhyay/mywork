...
Feature: Basic Authorization Validation
  ...
  Scenario Outline: A basic authentication based api validation. 
    ...
    Examples:
      ...
      | https://ssgosge.emc.com/prd/b2c/ldap/api/persons          | cpe_l7apiuser  | cpe_l7apiuser  | 200        | 
      | https://ssgosge.emc.com/prd/b2c/ldap/api/persons          | cpe_l7apiuser  | cpe_l7apiuser1 | 401        |
