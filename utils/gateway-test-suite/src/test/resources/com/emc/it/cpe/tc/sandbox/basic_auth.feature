...
Feature: Basic Authorization Validation
  ...
  Scenario Outline: A basic authentication based api validation. 
    ...
    Examples:
      ...
      | https://ssgosgsbx.isus.emc.com/sbx/cpeldap/api/persons           | cpe_l7apiuser  | cpe_l7apiuser  | 200        | 
      | https://ssgosgsbx.isus.emc.com/sbx/cpeldap/api/persons           | cpe_l7apiuser  | cpe_l7apiuser1 | 401        |
